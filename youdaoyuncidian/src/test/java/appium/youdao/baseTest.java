...
public class baseTest {
	...
	public void d() {
		...
		caps.setCapability(MobileCapabilityType.APP, System.getProperty("user.dir")+pro.readProperties("APP"));
		caps.setCapability(MobileCapabilityType.AUTOMATION_NAME, AutomationName.ANDROID_UIAUTOMATOR2);
		caps.setCapability(AndroidMobileCapabilityType.RECREATE_CHROME_DRIVER_SESSIONS, true);
		caps.setCapability(AndroidMobileCapabilityType.CHROMEDRIVER_EXECUTABLE, System.getProperty("user.dir")+pro.readProperties("CHROME_DRIVER"));
